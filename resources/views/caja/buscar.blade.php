<div>
    ...
    <button
    class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 rounded-full text-sm px-3 py-2 mr-1 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
    id="btnexportarexcel" title="Exportar a Excel" type="button" onclick="exportTableToExcel('tablareporte', 'REPORTE PRESTAMOS')"><i class="fas fa-file-excel"></i>Generar Archivo Excel</button>
