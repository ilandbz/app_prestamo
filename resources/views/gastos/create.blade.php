        ...
        <table class="w-full mt-6">
            <tr>
                ...
                <td class="p-2">
                    ...
                    <x-text-input id="concepto" class="block mt-1 w-full uppercase" type="text" name="concepto" :value="old('concepto')" required autofocus />
                    <x-input-error :messages="$errors->get('concepto')" class="mt-2" field="concepto" />
                </td>
                <td class="p-2">
